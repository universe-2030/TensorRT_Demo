#ifndef TRAININGUSERFORM_H
#define TRAININGUSERFORM_H
...
namespace Ui {
class TrainingUserForm;
}

class TrainingUserForm : public QWidget {
    Q_OBJECT

public:
    explicit TrainingUserForm(QWidget *parent = nullptr);
    ~TrainingUserForm();
